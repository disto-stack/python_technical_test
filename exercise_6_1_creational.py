# En este ejemplo voy a explicar e implementar un patron de diseño, el elegido es Singleton

'''
  Es un patron que grantiza la creacion de una sola instancia de una clase a lo largo del ciclo 
  de vida de una aplicacion. Mas en https://www.geeksforgeeks.org/singleton-pattern-in-python-a-complete-guide
'''
...
class ClaseSingleton():
  '''
    El metodo __new__ es un metodo estático perteneciente a la clase de un objeto, 
...
# Se verifica las instancias, si esta correcta la implementacion del patron, debe dar la salida:
